...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0v6qifk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0v6qifk.containers.anotherwebservice.com/
...
```
git clone git@github.com:alexrodri442/container-0v6qifk.git
cd container-0v6qifk
```
...
```
docker attach container-0v6qifk
```
